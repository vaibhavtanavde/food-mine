...
app.get('/analyze', (req, res) => {
    ...
    const graph = analyzeSourceTestRelationship(sourceFilePaths, testFilePaths, outputDir = __dirname);

    const dotFilePath = path.join(__dirname, 'graph.dot');
    graph.output('dot', dotFilePath);

    const svgFilePath = path.join(outputDir, 'graph.svg'); // Modify this line to use the output directory
